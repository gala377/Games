...
public class MapCreate : MonoBehaviour {
    ...
    {
        AssetDatabase.CreateAsset(ceilingObject.GetComponent<MeshFilter>().mesh, "Assets/CaveCeiling" + "_Mesh" + ".asset");
        AssetDatabase.CreateAsset(floorObject.GetComponent<MeshFilter>().mesh, "Assets/FloorCeiling" + "_Mesh" + ".asset");
